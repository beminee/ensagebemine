...
namespace EzGoldSharp.UnitManager
{
    ...
    internal class AllyHeroes
    {
        ...
        {
            var list = ObjectManager.GetEntitiesFast<Hero>().Where(x => x.Team == Variables.Me.Team && x.IsValid && !x.IsIllusion && x.IsVisible).ToList();
        ...
        internal class EnemyHeroes
        {
            ...
            private static void UpdateHeroes()
            {
                try
                {
                    var list = ObjectManager.GetEntitiesFast<Hero>().Where(x => x.Team != Variables.Me.Team).ToList();
            ...
            private static void UpdateIllusions()
            {
                try
                {
                    ...
                    var list = ObjectManager.GetEntitiesFast<Hero>()
