...
public class ChatListener implements IListener<MessageReceivedEvent> {
  ...
  private final String helptext_admin =
      "Tayyip-Bot admin usage:\n```\n"
          + "!tayyip-admin\t[options]\n"
          + "\nOptions:\n\n"
          + "  -h, --help                         \tShow this message\n"
  ...
  public void handle(MessageReceivedEvent event) {
    ...
    // support-console
    if (message.startsWith("!tayyip-admin") && user.getID().equals(Main.getInstance().adminID)) {
      handleAdmin(event);
      return;
    }
  ...
  private void handleAdmin(MessageReceivedEvent event) {
    ...
    message = message.replace("!tayyip-admin ", "");
            ...
            Main.getInstance()
                .writeMessage(
                    ...
                    "You have successfully opened ticket #"
                        + request.ticket_id
                        + ".\nYou can add further comments by typing '!tayyip -t (--ticket) "
                        + request.ticket_id
                        + " <message>'");
